CREATE TABLE TAFD001_MASTER_DATA (
   ...
   CREATE_USER_C 			VARCHAR(8)           NULL,
   CREATE_S     			DATETIME             NULL,
   LAST_UPDT_USER_C 		VARCHAR(8)           NULL,
   LAST_UPDT_S  			DATETIME             NULL,
...
CREATE TABLE TADF005_FOUNDATION_DATA_CLMN (
   ...
   CREATE_USER_C 				VARCHAR(8)           NOT NULL,
   CREATE_S     				DATETIME             NOT NULL,
   LAST_UPDT_USER_C 			VARCHAR(8)       	 NOT NULL,
   LAST_UPDT_S  				DATETIME             NOT NULL,
