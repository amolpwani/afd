 ...
 * */
angular.module('AfdUiAppListItemComponentsModule').service('ListItemService', ['$q', '$state', '$translate', 'WcHttpEndpointPrototype', 'WcAlertConsoleService', 'ConflictNotificationModalService',
