 ...
 * */
angular.module('AfdUiAppListComponentsModule').factory('ListData', function($resource) {
...
//angular.module('AfdUiAppListComponentsModule').service('ListService', ['$q', '$state', '$translate', 'WcHttpEndpointPrototype', 'WcAlertConsoleService', 'ConflictNotificationModalService',
//	function ($q, $state, $translate, WcHttpEndpointPrototype, WcAlertConsoleService, ConflictNotificationModalService) {
//
//		//noinspection JSValidateJSDoc
//		/**
//		 * @ngdoc property
...
//		 */
//		this.listEndpoint = new WcHttpEndpointPrototype('listdataitems/getItems');
//
//		/**
//		 * @ngdoc method
//		 * @name getLists
