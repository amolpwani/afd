...
describe('AfdUiAppListItemComponentsModule ListItemPrototype:', function() {
	//Dependencies
	...
	beforeEach(function() {
		...
		fullObject = new ListItemPrototype({"id":"7","name":"List1","description":"Test List","active":false});
	});
	...
	describe('Function [calculateTotalPrice]:', function() {
		it('should be defined', function() {
			expect(angular.isFunction(ListItemPrototype.prototype.calculateTotalPrice)).toBe(true);
		});
	...
	describe('Function [calculateTripDuration]:', function() {
		it('should be defined', function() {
			expect(angular.isFunction(ListItemPrototype.prototype.calculateTripDuration)).toBe(true);
		});
	...
	describe('Function [removeCalculatedFields]:', function() {
		it('should be defined', function() {
			expect(angular.isFunction(ListItemPrototype.prototype.removeCalculatedFields)).toBe(true);
		});
	...
	describe('Function [convertDates]:', function() {
		it('should be defined', function() {
			expect(angular.isFunction(ListItemPrototype.prototype.convertDates)).toBe(true);
		});
	...
	describe('Function [prepareForAction]:', function() {
		it('should be defined', function() {
			expect(angular.isFunction(ListItemPrototype.prototype.prepareForAction)).toBe(true);
		});
