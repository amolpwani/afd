...
describe('NewUiAppModule:', function() {
	//Module
	var NewUiAppModule;
	...
	beforeEach(function() {
		...
		$templateCache.put('newUiApp/newUiAppTemplate.html', '');
		$templateCache.put('newUiApp/states/home/homeTemplate.html', '');
	});

	it('should ensure NewUiAppModule module was registered', function() {
